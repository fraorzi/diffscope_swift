...
runRedrawChecks { name, ok, detail in report(name, ok, detail) }
runHookDrainChecks { name, ok, detail in report(name, ok, detail) }
runStagingStateChecks { name, ok, detail in report(name, ok, detail) }
