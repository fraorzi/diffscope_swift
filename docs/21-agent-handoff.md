...
**What is left of the design after this:** nothing on the six-item list, and the two phrases the engine cannot justify are still deliberately undrawn (below). The `dist/` zip is now **many commits behind** — repackage before handing it to anyone.
