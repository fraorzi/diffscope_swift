...
**Status, 2026-08-17 ([DEC-098](04-decision-log.md)): M11 through M17 are built**, in four commits and one session, with 1832 → 1913 checks and a selftest arm that stages a file and commits it through the controls. What is deliberately absent is named under the table: submodules, pull requests and checks, and a three-way merge surface.
